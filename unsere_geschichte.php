...
<div class="text-center container-fluid">
  <div class="row">
    ...
    <div class="col-12">
      ...
      <h1 class="h1 mb-3 fw-normal">Unsere Chronik</h1>
              ...
              <div id="carouselExampleSlidesOnly" class="carousel slide carousel-fade" data-bs-ride="carousel">
                <div class="carousel-inner">
                  <div class="carousel-item active" data-bs-interval="2000">
                    <img src="Images/Hotel/Hotel_1952_600x400.jpg" class="d-block w-100" alt="Foto Hotel 1952">
                  </div>
          ...
          <div class="row featurette">
            ...
            <div class="col-md-5 order-md-1">
              ...
              <div id="carouselExampleSlidesOnly" class="carousel slide carousel-fade" data-bs-ride="carousel">
                <div class="carousel-inner">
                  <div class="carousel-item active" data-bs-interval="2000">
                    <img src="Images/Hotel/Hotel_1982_600x400.jpg" class="d-block w-100" alt="Foto Hotel 1982">
                  </div>
          ...
          <div class="row featurette">
            ...
            <div class="col-md-5 order-md-2">
              ...
              <div id="carouselExampleSlidesOnly" class="carousel slide carousel-fade" data-bs-ride="carousel">
                <div class="carousel-inner">
                  <div class="carousel-item active" data-bs-interval="2000">
                    <img src="Images/Hotel/Hotel_2012_600x400.jpg" class="d-block w-100" alt="Foto Hotel 2012">
                  </div>
          ...
          <div class="row featurette">
            ...
            <div class="col-md-5 order-md-1">
              ...
              <div id="carouselExampleSlidesOnly" class="carousel slide carousel-fade" data-bs-ride="carousel">
                <div class="carousel-inner">
                  <div class="carousel-item active" data-bs-interval="2000">
                    <img src="Images/Hotel/Hotel_2014_600x400.jpg" class="d-block w-100" alt="Foto Hotel 2014">
                  </div>
          ...
          <div class="row featurette">
            ...
            <div class="col-md-5 order-md-2">
              ...
              <div id="carouselExampleSlidesOnly" class="carousel slide carousel-fade" data-bs-ride="carousel">
                <div class="carousel-inner">
                  <div class="carousel-item active" data-bs-interval="2000">
                    <img src="Images/Hotel/Hotel_2021_600x400.jpg" class="d-block w-100" alt="Foto Hotel 2021">
                  </div>
      ...
      <hr class="featurette-divider">
      <br>
      <p>VERGANGENHEIT IST GESCHICHTE, <br> ZUKUNFT EIN GEHEIMNIS <br> UND JEDER AUGENBLICK EIN GESCHENK.</p>
