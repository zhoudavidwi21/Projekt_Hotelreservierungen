    ...
    <form method="POST">
        ...
        <div class="row mb-1">
            ...
            <div class="col-sm-6 col-md-5 col-lg-3">
                ...
                <input class="form-control" id="oldEmail" type="email" value="some sql data" aria-label="Disabled input example" disabled readonly>
            </div>
            <div class="col">
            </div>
        </div>
        ...
        <div class="row mb-1">
            ...
            <div class="col-sm-6 col-md-5 col-lg-3">
                ...
                <input class="form-control" id="oldUsername" type="text" value="some sql data" aria-label="Disabled input example" disabled readonly>
            </div>
            <div class="col">
            </div>
        </div>
        ...
        <div class="row mb-5">
            ...
            <div class="col-sm-6 col-md-5 col-lg-3">
                ...
                <label for="newPassword" class="d-flex justify-content-start"></label>
                <input class="form-control" id="newPassword" placeholder="neues Passwort wiederholen" name="newPassword" type="password">
            </div>
            <div class="col">
            </div>
        </div>
